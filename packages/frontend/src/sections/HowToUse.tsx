        ...
        <div className="container mx-auto  flex flex-col items-center gap-16">
          ...
          <div className="flex w-full flex-col items-center justify-between gap-y-10 lg:flex-row lg:gap-x-8 lg:gap-y-0 xl:gap-x-10 ">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-solid border-blue-4 bg-transparent text-dark-grey-600">
                <span className="text-base text-blue-4 font-bold leading-7">
                  1
                </span>
              </div>
              <div className="flex flex-col">
                ...
                <p>Sign up now and explore our comprehensive learning tools.</p>
              </div>
            </div>
