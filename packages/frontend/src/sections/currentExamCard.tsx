  ...
  return (
    <div className="h-full lg:w-2/4 md:w-3/4 sm:w-3/4 bg-[#FEFDFA] rounded-xl flex flex-col items-center py-2 text-center shadow-md ">
      <div className="w-full flex justify-between items-start  px-5">
        ...
        <h3 className="lg:text-4xl font-semibold md:text-3xl sm:text-2xl ">{title}</h3>
          <div className="flex flex-row mt-2 ">
            <h4 className="text-[#989896] lg:text-md md:text-sm sm:text-xs">Start Date :</h4>
            <h4 className="text-[#989896] lg:text-md md:text-sm sm:text-xs">{startDate}</h4>
          </div>
        ...
        <div className="hidden lg:block md:hidden">
          ...
          <div className="block md:hidden">
            <Progress percentage={70} circleWidth={70} radius={30} />
          </div>
      </div>
    </div>
  );
