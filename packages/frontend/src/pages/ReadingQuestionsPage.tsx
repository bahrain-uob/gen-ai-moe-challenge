  ...
  return (
    <>
      ...
      <Modal
        ...
        modalMessage={
          <div>
            <ul className="list-disc  mt-5 pr-10 list-inside">
              ...
              <li className="mt-4  text-justify">
                You should aim to spend no more than 20 minutes on each part. As
                the test progresses, the sections increase in difficulty, so
                make sure you allow yourself enough time to complete each
                section. .
              </li>
            </ul>
          </div>
