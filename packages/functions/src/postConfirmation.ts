...
/**
 * This function is called after a user has been confirmed to intiialize the user in the database
 *
...
const handler = async (event: any, context: any) => {
  ...
  if (event.triggerSource === 'PostConfirmation_ConfirmSignUp') {
    ...
    const command = new UpdateCommand({
      ...
      UpdateExpression: 'SET students = list_append(if_not_exists(students, :init), :ID)',
